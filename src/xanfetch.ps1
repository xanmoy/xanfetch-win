...
.AUTHOR xanmoy
.PROJECTURI https://github.com/xanmoy/xanfetch
.COMPANYNAME
.COPYRIGHT
.TAGS
.LICENSEURI
...
<#
.SYNOPSIS
    XanFetch - Neofetch for Windows in PowerShell 5+
.DESCRIPTION
...
$img = if (-not $image -and -not $noimage.IsPresent -and $strings.os -Match 'Windows 10') {
    ...
    @(
        ...
        "$eby·$ee $ebb################$eh$eby·$ee$ebb################$eh $ebr·$ee",
        "$ebt·$ee $ebb################$eh$es·$ee$ebb################$eh $ebt·$ee",
        "$ebg·$ee $ebb################$eh$ebr·$ee$ebb################$eh $eby·$ee",
        "$ebr·$ee $ebb################$eh$ebg·$ee$ebb################$eh $ebg·$ee",
        "$eby·$ee $ebb################$eh$ebt·$ee$ebb################$eh $eby·$ee",
        "$ebt·$ee $ebb################$eh$eby·$ee$ebb################$eh $ebt·$ee",
        "$ebg·$ee $ebb################$eh$es·$ee$ebb################$eh $ebg·$ee",
        "$ebr·$ee $ebb################$eh$ebr·$ee$ebb################$eh $ebr·$ee",
        ...
        "$ebr·$ee $ebb################$eh$eby·$ee$ebb################$eh $ebt·$ee",
        "$eby·$ee $ebb################$eh$es·$ee$ebb################$eh $eby·$ee",
        "$ebt·$ee $ebb################$eh$ebr·$ee$ebb################$eh $ebg·$ee",
        "$ebg·$ee $ebb################$eh$ebg·$ee$ebb################$eh $ebr·$ee",
        "$ebr·$ee $ebb################$eh$ebt·$ee$ebb################$eh $ebg·$ee",
        "$eby·$ee $ebb################$eh$eby·$ee$ebb################$eh $eby·$ee",
        "$ebt·$ee $ebb################$eh$es·$ee$ebb################$eh $ebt·$ee",
        "$ebg·$ee $ebb################$eh$ebr·$ee$ebb################$eh $ebr·$ee",
        "$ebt·$ee $ebr·$ee $eby·$ee $ebt·$ee $ebg·$ee $ebr·$ee $eby·$ee $ebt·$ee $ebg·$ee $ebr·$ee $eby·$ee $ebt·$ee $ebg·$ee $ebr·$ee $eby·$ee $ebt·$ee $ebg·$ee $ebt·$ee $es·$ee"
    )
}
else {
...
function Get-BatteryInfo {
    try {
        ...
        if ($battery) {
            ...
            $connectionStatus = if ($battery.BatteryStatus -eq 2) {
                'Connected'
            } else {
                'Unplugged'
            }
            return "$chargeRemaining% , $connectionStatus"
        } else {
            Write-Host "Battery information is not available." -ForegroundColor Yellow
            return "N/A"
        }
    } catch {
        Write-Host "Error retrieving battery information: $_" -ForegroundColor Red
        return "Error"
    }
}
